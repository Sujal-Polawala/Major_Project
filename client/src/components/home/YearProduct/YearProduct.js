      ...
      <div className="w-full h-auto md:h-80 mb-20 bg-[#f3f3f3] relative font-titleFont rounded-lg overflow-hidden shadow-md">
        {loading ? (
          ...
          <>
            ...
            />
            <div className="md:w-fit h-80 w-2/3 xl:w-1/2 bg-black bg-opacity-40 absolute top-0 right-0 items-start gap-6 flex flex-col justify-center p-6 md:p-12 text-white">
